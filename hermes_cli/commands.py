...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("whoami", "Show your slash command and ACL access (admin / user)", "Info"),
    CommandDef("acl", "Manage gateway ACL memberships and groups", "Configuration",
               gateway_only=True, args_hint="[show|grant|revoke|group|audit]",
               subcommands=("show", "grant", "revoke", "group", "audit")),
...
#   - version: low-frequency build metadata; reached via /hermes version on Slack.
